        ...
        var swiperThumbs = new Swiper(".hero-thumbs-slide", {
            ...
            on: {
                slideChange: function () {
                   ...
                   // $('.hero-thumbs-slide .swiper-slide').removeClass('swiper-slide-thumb-active');
    
                    // Calculate the leftmost visible slide index
                    var leftmostIndex = this.activeIndex; // Change from realIndex to activeIndex
    
                    // Add the active class to the leftmost visible slide
                    //$('.hero-thumbs-slide .swiper-slide').eq(leftmostIndex).addClass('swiper-slide-thumb-active');
                }
            }
        });
